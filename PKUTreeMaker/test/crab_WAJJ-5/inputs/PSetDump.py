...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/user/m/melu/public/041A166C-B53F-E611-BF34-5CB90179CCC0.root'),
...
process.analysis = cms.Path(process.JetUserData+process.leptonSequence+process.jetSequence+process.metfilterSequence+process.photonIDValueMapProducer+process.treeDumper)
